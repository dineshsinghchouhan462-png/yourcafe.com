...
export default function Footer() {
  ...
  return (
    <footer
      ...
      `}
    >
      {/* TOP FADE — terminal cue */}
      <div className="absolute top-0 left-0 right-0 h-24 bg-gradient-to-b from-[#f7f4ef] to-transparent pointer-events-none" />
      ...
      <div className="relative bg-[#e9e4dc]">
        ...
        <div className="relative max-w-[1100px] mx-auto px-6 pt-24 pb-20 space-y-20">
          ...
          <div className="text-center space-y-4">
            <h2 className="font-serif text-[28px] md:text-[30px] text-[#1f1f1f]">
              Coffee. Comfort. Care.
            </h2>
          ...
          {/* COPYRIGHT */}
          <p className="text-center footer-label text-gray-500">
            © 2026 The Lazy Barn
          </p>
